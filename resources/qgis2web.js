...
map.getView().fit([15647982.878394, -545422.858268, 15659620.636077, -540310.850272], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PETA ADMINISTRASI KAWASAN PERKOTAAN OKSIBIL</h2>';
        return titleElement;
    })(),
